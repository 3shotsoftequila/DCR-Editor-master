import DCRTreeWalker from './DCRTreeWalker';
 ...
 */
export function importDcrDiagram(diagram, definitions, rootBoard) {
   ...
   *
   * @param {ModdleElement<Definitions>} definitions
   * @param {ModdleElement<DCRRootBoard>} rootBoard
   */
  ...
  return new Promise(function(resolve, reject) {
    try {
      importer = diagram.get('DCRImporter');
